        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Description of Creditors</h3>
                </div>
                <form action="{{ route('npv-categories.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div>
                                ...
                                <div>
                                    <input type="checkbox" data-bootstrap-switch="" name="is_active" {{ old('is_active', 1) ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                    </div>
